...
-- Quitly arbeitet ohne Netz. Hammerspoon würde von sich aus per Sparkle
-- nach Updates suchen, das ist die einzige ausgehende Verbindung im
-- Paket. Sie wird abgeschaltet, die Version kommt über den Installer.
-- Wer die Prüfung zurück will: hs.automaticallyCheckForUpdates(true)
pcall(hs.automaticallyCheckForUpdates, false)
